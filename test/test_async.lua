...
service:dispatch(coroutine.create(function ()
  service:add_handler(io_handler(fd2, "write", coroutine.create(function (service, handler, event)
    print(event)
    service:del(handler)
    fd2:write("x")
    service:add_handler(io_handler(fd1, "read", coroutine.create(function (service, handler, event)
      print(event)
      service:del(handler)
      assert(fd1:read(1) == "x")
      service:stop()
